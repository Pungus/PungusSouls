...
namespace PungusSouls
{
    public static class Animations
    {
        ...
        public static void LoadAssets()
        {
            ...
            _customClips["GS_Sprint_Forward"] = PungusSoulsPlugin.asset.LoadAsset<AnimationClip>("GS_Sprint_Forward");
            _customClips["GS_Jog_Forward"] = PungusSoulsPlugin.asset.LoadAsset<AnimationClip>("GS_Jog_Forward");
            _customClips["GS_Walk_Forward"] = PungusSoulsPlugin.asset.LoadAsset<AnimationClip>("GS_Walk_Forward");
            _customClips["GS_Strafe_Left"] = PungusSoulsPlugin.asset.LoadAsset<AnimationClip>("GS_Strafe_Left_Fast");
            _customClips["GS_Strafe_Right"] = PungusSoulsPlugin.asset.LoadAsset<AnimationClip>("GS_Strafe_Right_Fast");

            _customClips["Greatsword_Attack1"] = PungusSoulsPlugin.asset.LoadAsset<AnimationClip>("Greatsword_Attack1");
            _customClips["Greatsword_Attack2"] = PungusSoulsPlugin.asset.LoadAsset<AnimationClip>("Greatsword_Attack2");
            _customClips["Greatsword_Attack3"] = PungusSoulsPlugin.asset.LoadAsset<AnimationClip>("Greatsword_Attack3");        
